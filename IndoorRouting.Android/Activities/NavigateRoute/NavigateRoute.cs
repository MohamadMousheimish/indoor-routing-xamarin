...
using IndoorRouting.Android.Activities.NavigateRoute;
...
namespace IndoorRouting.Android.NavigateRoute
{
    [Activity(ConfigurationChanges = ConfigChanges.Orientation | ConfigChanges.ScreenSize)]
    [Sample("Navigate Route", "Network Analysis", "Use a routing service to navigate between points","")]
    [OfflineData()]
     ...
     * The location source that it updated is based on the snapped-to-route location from the route tracker
     */
